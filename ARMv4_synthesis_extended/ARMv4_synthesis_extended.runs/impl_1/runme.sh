...
HD_PWD='D:/School Work/Senior Design/project_repo/Verilog-ARMv4/ARMv4_synthesis_extended/ARMv4_synthesis_extended.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ARMv4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ARMv4.tcl -notrace
