...
HD_PWD='D:/School Work/Senior Design/project_repo/Verilog-ARMv4/ARMv4_synthesis_extended/ARMv4_synthesis_extended.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ARMv4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ARMv4.tcl
